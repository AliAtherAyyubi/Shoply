  ...
  return (
    ...
    <div className="grid lg:grid-cols-2 gap-12">
        <div>
            <div className="bg-gray-100 p-6 rounded-md">
                ...
                <div className="space-y-4 mt-8">
                    ...
                    <CartItemCard productNo={1}/>
                    <hr className="border-gray-300" />
                    <CartItemCard productNo={2}/> 

                    <hr className="border-gray-300" />

                    <CartItemCard productNo={3}/>
                   
                </div>
            </div>

            <div className="mt-4 flex flex-wrap justify-center gap-4">
                <img src='/img/product/product-1.jpg' alt="card1" className="w-12 object-contain" />
                <img src='/img/product/product-2.jpg' alt="card2" className="w-12 object-contain" />
                <img src='/img/product/product-3.jpg' alt="card3" className="w-12 object-contain" />
            </div>
        </div>
        ...
        <form>
            ...
            <div className="grid gap-4 mt-8">
                <div>
                    ...
                    <input type="text" placeholder="John Doe"
                        className="px-4 py-3 bg-transparent text-gray-800 w-full text-sm border border-gray-300 rounded-md focus:border-pink-500 outline-none" />
                </div>

                <div>
                    <label className="block text-base font-semibold text-gray-800 mb-2">Card Number</label>
                    <div className="flex bg-transparent border border-gray-300 rounded-md focus-within:border-pink-500 overflow-hidden">
            ...
            <button type="button" className="mt-8 text-sm px-4 py-3 w-full font-semibold tracking-wide bg-pink-600 hover:bg-pink-700 text-white rounded-md">Make Payment  </button>
        </form>
    </div>
</div>
  )
